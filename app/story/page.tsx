    ...
    <div className="flex flex-col items-center justify-center bg-black px-4 py-2 md:py-10 gap-6">
      ...
      >
        ...
        <div className="h-full flex flex-col items-center justify-center bg-white/10 text-white rounded-br-lg">
          ...
          <p className="mt-1 lg:leading-20 leading-10 text-2xl text-center md:text-4xl font-bold">The Code He Feared Became <br /> His <br /> Voice in a Journey <br /> Through Impossible Lines <br /> from <br /> Shadows to Syntax</p>
        </div>
