...
const watch = [
   ...
   className="w-7 h-7 stroke-white fill-white"><path d="M256 0c4.6 0 9.2 1 13.4 2.9L457.8 82.8c22 9.3 38.4 31 38.3 57.2-.5 99.2-41.3 280.7-213.6 363.2-16.7 8-36.1 8-52.8 0-172.4-82.5-213.1-264-213.6-363.2-.1-26.2 16.3-47.9 38.3-57.2L242.7 2.9C246.9 1 251.4 0 256 0zm0 66.8l0 378.1c138-66.8 175.1-214.8 176-303.4l-176-74.6 0 0z"/>
    ...
    },
    {
     ...
     xmlns="http://www.w3.org/2000/svg" 
     viewBox="0 0 512 512"
     className="w-7 h-7 stroke-white fill-white"><path d="M448 256a192 192 0 1 0 -384 0 192 192 0 1 0 384 0zM0 256a256 256 0 1 1 512 0 256 256 0 1 1 -512 0zm256 80a80 80 0 1 0 0-160 80 80 0 1 0 0 160zm0-224a144 144 0 1 1 0 288 144 144 0 1 1 0-288zM224 256a32 32 0 1 1 64 0 32 32 0 1 1 -64 0z"/></svg>
        ),
        text:"PRECISION",
    },
    {
     ...
     xmlns="http://www.w3.org/2000/svg" 
     viewBox="0 0 512 512"
     className="w-7 h-7 stroke-white fill-white"><path d="M128 320L24.5 320c-24.9 0-40.2-27.1-27.4-48.5L50 183.3C58.7 168.8 74.3 160 91.2 160l95 0c76.1-128.9 189.6-135.4 265.5-124.3 12.8 1.9 22.8 11.9 24.6 24.6 11.1 75.9 4.6 189.4-124.3 265.5l0 95c0 16.9-8.8 32.5-23.3 41.2l-88.2 52.9c-21.3 12.8-48.5-2.6-48.5-27.4L192 384c0-35.3-28.7-64-64-64l-.1 0zM400 160a48 48 0 1 0 -96 0 48 48 0 1 0 96 0z"/></svg>
        ),
        text:"PERFORMANCE",
    }
]
                ...
                <div className="m-5">
                    ...
                    <div className="flex m-5 justify-center ">
                        <div className="flex flex-wrap justify-center gap-10 ">{watch.map((item, index)=>(
                            <div className="flex flex-col items-center justify-center bg-[#232325]  px-10 py-10 rounded-xl text-center min-w-37.5" key={index}>
                                <div>{item.svg}</div>
                                <div>{item.text}</div>
                            </div>
                        ))}</div>
